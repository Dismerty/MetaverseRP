...
Если уже у вас есть аккаунт, то пропишите /login.</i>'''
    ...
    await message.answer(msg.add(f'Добро пожаловать в игровое пространство <a href="https://vk.com/anime_rpg_project">{game}</a>!{MessageModifier}'), disable_web_page_preview = True)
